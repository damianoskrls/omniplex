  ...
  Future<void> _delete(String leaveId) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text('Διαγραφή άδειας;'),
        content: const Text('Η άδεια θα διαγραφεί οριστικά.'),
        actions: [
          ...
          : _error != null
              ...
              : _leaves.isEmpty
                  ? EmptyState(
                      ...
                      subtitle: 'Πάτα + για να προσθέσεις νέα άδεια.',
                    )
                  : RefreshIndicator(
                      onRefresh: _load,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Νέα άδεια', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 18)),
